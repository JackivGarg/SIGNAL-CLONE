...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("contact_id", sa.String(length=36), sa.ForeignKey("users.id", ondelete="CASCADE")),
    ...
    op.create_table(
        ...
        sa.Column("created_by_id", sa.String(length=36), sa.ForeignKey("users.id", ondelete="RESTRICT")),
    ...
    op.create_table(
        ...
        sa.Column("sender_id", sa.String(length=36), sa.ForeignKey("users.id", ondelete="RESTRICT"), nullable=False),
        sa.Column("client_message_id", sa.String(length=36), nullable=False),
        sa.Column("body", sa.Text(), nullable=False),
        sa.Column("reply_to_id", sa.String(length=36), sa.ForeignKey("messages.id", ondelete="SET NULL")),
